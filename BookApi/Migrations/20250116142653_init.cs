...
namespace BookApi.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "AuthorId", "CategoryId", "Title" },
                values: new object[,]
                {
                    { 1, null, 1, "Harry Potter ve Felsefe Taşı" },
                    { 2, null, 2, "Suç ve Ceza" },
                    { 3, null, 3, "Yıldız Gemisi Askerleri" },
                    { 4, null, 4, "Cinayet Alfabesi" },
                    { 5, null, 5, "Savaş ve Barış" }
                });
